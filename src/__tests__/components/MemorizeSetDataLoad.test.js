...
//Test Case ID: Test125
test('Checks that the not permitted message is shown when the data has not been found for the MemorizeSetDataLoad page', async () => {
    ...
    await render(<MemorizeSetDataLoad setId={setId} currentUser={currentUser} setInfo={setInfo}/>)
    screen.debug()
